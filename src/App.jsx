        ...
        {step === 1 && (
          <form onSubmit={handleZipCheck}>
            ...
            <button type="submit" style={{
              ...
              border: 'none', borderRadius: '6px', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer', marginTop: '10px'
        ...
        {step === -1 && (
          <div style={{ textAlign: 'center' }}>
            ...
            <button onClick={() => setStep(1)} style={{
              width: '100%', padding: '14px', background: '#444', color: '#fff',
              border: 'none', borderRadius: '6px', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer', marginTop: '10px'
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'flex', gap: '10px' }}>
              <div style={{ flex: 1 }}>
                <input type="text" required style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box' }} placeholder="First Name *" value={firstName} onChange={e => setFirstName(e.target.value)} />
              </div>
              <div style={{ flex: 1 }}>
                <input type="text" required style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box' }} placeholder="Last Name *" value={lastName} onChange={e => setLastName(e.target.value)} />
              </div>
            </div>

            <input type="tel" required style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box' }} placeholder="Phone Number *" value={phone} onChange={e => setPhone(e.target.value)} />
            <input type="email" required style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box' }} placeholder="Email Address *" value={email} onChange={e => setEmail(e.target.value)} />
            
            <div style={{ display: 'flex', gap: '10px' }}>
              <div style={{ flex: 2 }}>
                <input type="text" required style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box' }} placeholder="Street Address *" value={street} onChange={e => setStreet(e.target.value)} />
              </div>
              <div style={{ flex: 1 }}>
                <input type="text" style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box' }} placeholder="Unit/Apt" value={unit} onChange={e => setUnit(e.target.value)} />
              </div>
            </div>

            <div style={{ display: 'flex', gap: '10px' }}>
              <div style={{ flex: 2 }}>
                <input type="text" required style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box' }} placeholder="City *" value={city} onChange={e => setCity(e.target.value)} />
              </div>
              <div style={{ flex: 1 }}>
                <input type="text" disabled style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box', opacity: 0.7 }} value="MA" />
              </div>
            </div>

            <textarea required style={{ width: '100%', padding: '12px', marginBottom: '16px', borderRadius: '6px', border: '1px solid #444', background: '#2c2c2c', color: '#fff', fontSize: '16px', boxSizing: 'border-box', minHeight: '80px' }} placeholder="Briefly describe what you need done..." value={projectNotes} onChange={e => setProjectNotes(e.target.value)} />
